...
public class JsonMain {
    ...
    private static String toJSON(SimpleOuterClass.Simple message)
    ...
    public static SimpleOuterClass.Simple fromJSON(String json) throws InvalidProtocolBufferException {
